...
# === 2. MODYFIKOWALNE BUFORY KESZU TRANSPOSITION TABLE (O(1)) ===
...
# === 3. BŁYSKAWICZNE OPERACJE BITOWE O(1) ===
...
# === 4. SPRAWDZONA MATEMATYCZNIE MACIERZ WĘŻA Z D4 SYMMETRY ===
...
# === 5. EXPECTIMAX V6 Z PRZEKAZYWANIEM TABLIC CACHE ===
...
def get_v6_god_move(board_np, valid_mask=None):
    ...
    # GLĘBOKA ANALIZA DEPTH 6 Z CACHEM O(1)
    if empty_tiles <= 3:
        target_depth = 6
    else:
        target_depth = 5
